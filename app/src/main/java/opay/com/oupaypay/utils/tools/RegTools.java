package opay.com.oupaypay.utils.tools;
...
public class RegTools {
    ...
    public static boolean isMobileSimple(String string) {
        return isMatch(Constants.REGEX_MOBILE_SIMPLE, string);
    }
    ...
    public static boolean isMobileExact(String string) {
        return isMatch(Constants.REGEX_MOBILE_EXACT, string);
    }
    ...
    public static boolean isTel(String string) {
        return isMatch(Constants.REGEX_TEL, string);
    }
    ...
    public static boolean isIDCard15(String string) {
        return isMatch(Constants.REGEX_IDCARD15, string);
    }
    ...
    public static boolean isIDCard18(String string) {
        return isMatch(Constants.REGEX_IDCARD18, string);
    }
    ...
    public static boolean isIDCard(String string) {
        return isMatch(Constants.REGEX_IDCARD, string);
    }
    ...
    public static boolean isEmail(String string) {
        return isMatch(Constants.REGEX_EMAIL, string);
    }
    ...
    public static boolean isURL(String string) {
        return isMatch(Constants.REGEX_URL, string);
    }
    ...
    public static boolean isChz(String string) {
        return isMatch(Constants.REGEX_CHZ, string);
    }
    ...
    public static boolean isUsername(String string) {
        return isMatch(Constants.REGEX_USERNAME, string);
    }
    ...
    public static boolean isDate(String string) {
        return isMatch(Constants.REGEX_DATE, string);
    }
    ...
    public static boolean isIP(String string) {
        return isMatch(Constants.REGEX_IP, string);
    }
